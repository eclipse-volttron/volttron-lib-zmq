...
from volttron.types import AgentContext
from volttron.types.auth import Credentials, CredentialsStore, PKICredentials
...
class ZmqCore(Core):
    ...
    def __init__(self,
        ...
        self.serverkey = get_server_credentials().publickey
