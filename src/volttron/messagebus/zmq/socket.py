...
class Address(object):
    ...
    def qs(self):
        ...
        return urllib.parse.urlencode({
            name: (value if name in self._MASK_KEYS and value else value)
    ...
    def bind(self, sock, bind_fn=None):
        ...
        _log.debug(f"Serverkey is: {self.secretkey}")
        ...
        if self.server == "CURVE":
            ...
            sock.curve_secretkey = decode_key(self.secretkey)
            ...
            if self.serverkey:
                sock.curve_serverkey = decode_key(self.serverkey)
